...
import deleteBook from '../redux/thank/deleteBook';

export default function SingleBook({ book, setIsUpdate }) {
  ...
  for (let i = 0; i < rating; i++) {
    ratingStars.push(<svg key={i} viewBox="0 0 20 20" fill="currentColor" className="lws-star">
